...
public class DaemonStrategy22 implements IDaemonStrategy {
    private static final int INTENT_FLAG = 22000;
    ...
    public void onPersistentCreate(final Context context, DaemonConfigurations configs) {
        initAmsBinder();
        initServiceParcel(context, configs.DAEMON_ASSISTANT_CONFIG.SERVICE_NAME, configs.INTENT_ACTION);
    ...
    public void onDaemonAssistantCreate(final Context context, DaemonConfigurations configs) {
        initAmsBinder();
        initServiceParcel(context, configs.PERSISTENT_CONFIG.SERVICE_NAME, configs.INTENT_ACTION);
        startServiceByAmsBinder();
    ...
    private void initServiceParcel(Context context, String serviceName, String intentAction) {
        Intent intent = new Intent();
        ComponentName component = new ComponentName(context.getPackageName(), serviceName);
        intent.setComponent(component);
        intent.setAction(intentAction + "_" + INTENT_FLAG);
