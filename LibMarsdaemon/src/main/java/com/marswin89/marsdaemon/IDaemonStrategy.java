...
public interface IDaemonStrategy {
     ...
     * @param configs
     */
    void onPersistentCreate(Context context, @NonNull DaemonConfigurations configs);
     ...
     * @param configs
     */
    void onDaemonAssistantCreate(Context context, @NonNull DaemonConfigurations configs);
